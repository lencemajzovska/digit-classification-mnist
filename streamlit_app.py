...
def load_model():
    ...
    if not os.path.exists(model_path):
        st.write("🔽 Försöker ladda ner modellen från Google Drive...")
        try:
        ...
        st.write("📁 Nedladdning klar. Finns filen?", os.path.exists(model_path))
        st.write("📦 Modellfilens storlek (om den finns):", os.path.getsize(model_path) if os.path.exists(model_path) else "❌")
